...
<body>
    ...
    <main class="container-fluid px-4">
        <div class="row g-4 py-5">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-2">
                        <div class="d-flex flex-column gap-3 thumbnail-container">
                            <img src="image_resources/resume/resume-2.webp" class="active" onclick="changeImage(this)">
                            <img src="image_resources/resume/resume-3.png" onclick="changeImage(this)">
                            <img src="image_resources/resume/resume-4.avif" onclick="changeImage(this)">
                            <img src="image_resources/resume/resume-5.png" onclick="changeImage(this)">
                        </div>
                    </div>
                    ...
                    <div class="col-10">
                        <div class="product-box shadow-sm">
                            <div class="zoom-container" id="zoomContainer">
                                <img src="image_resources/resume/resume-2.webp" id="mainView">
            ...
            <!-- RIGHT -->
            <div class="col-md-5">
                <h1 class="display-5 fw-800 text-primary mb-3"><strong>Resume</strong></h1>
                <p class="text-muted lead font-mina mb-4" style="font-weight: 300;">
                   Shine your a strategic marketing document that highlights your professional skills, experience, and achievements.
                </p>
                ...
                <a href="product_customization.php" class="btn btn-orange w-100 py-3 fs-5" data-product-id="8" onclick="goToCustomize(event)">
