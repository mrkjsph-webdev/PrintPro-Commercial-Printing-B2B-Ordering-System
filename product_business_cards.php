...
<body>
        ...
        <div class="row g-4 py-5">
            ...
            <div class="col-md-7">
                <div class="row g-3">
                    ...
                    <!-- THUMBNAILS -->
                    <div class="col-2">
                        <div class="d-flex flex-column gap-3 thumbnail-container">
                            <img src="image_resources/businesscard/businesscard-2.gif" class="active" onclick="changeImage(this)">
                            <img src="image_resources/businesscard/businesscard-3.gif" onclick="changeImage(this)">
                            <img src="image_resources/businesscard/business-card-4.png" onclick="changeImage(this)">
                            <img src="image_resources/businesscard/business-card-5.webp" onclick="changeImage(this)">
                        </div>
                    </div>
                    ...
                    <div class="col-10">
                        <div class="product-box shadow-sm">
                            <div class="zoom-container" id="zoomContainer">
                                <img src="image_resources/businesscard/businesscard-2.gif" id="mainView">
            ...
            <!-- RIGHT -->
            <div class="col-md-5">
                <h1 class="display-5 fw-800 text-primary mb-3"><strong>Business Cards</strong></h1>
                <p class="text-muted lead font-mina mb-4" style="font-weight: 300;">
                    Promote your business with high-impact custom postcards designed for marketing campaigns.
                </p>
                <hr class="my-4 opacity-50">
                <div class="d-flex gap-3 p-3 mb-4 bg-white rounded shadow-sm">
                    <img src="image_resources/box.png" width="35" height="35">
                    <div>
                        <p class="fw-bold mb-0">Pickup Delivery Only</p>
                        <p class="small text-muted mb-0">
                            Orders must be picked up at the store when order is completed.
                        </p>
                    </div>
                </div>

                <a href="product_customization.php" class="btn btn-orange w-100 py-3 fs-5" data-product-id="4" onclick="goToCustomize(event)">
    ...
    <script>
        ...
        // Reset zoom center when mouse leaves
        container.addEventListener('mouseleave', () => {
            img.style.transformOrigin = 'center center';
        });

        function goToCustomize(event) {
