...
<body>
    ...
    <main class="container-fluid px-4">
        <div class="row g-4 py-5">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-2">
                        <div class="d-flex flex-column gap-3 thumbnail-container">
                            <img src="image_resources/invitation/invite-1.png" class="active" onclick="changeImage(this)">
                            <img src="image_resources/invitation/invite-2.png" onclick="changeImage(this)">
                            <img src="image_resources/invitation/invite-3.png" onclick="changeImage(this)">
                            <img src="image_resources/invitation/invite-4.webp" onclick="changeImage(this)">
                        </div>
                    </div>
                    ...
                    <div class="col-10">
                        <div class="product-box shadow-sm">
                            <div class="zoom-container" id="zoomContainer">
                                <img src="image_resources/invitation/invite-1.png" id="mainView">
            ...
            <!-- RIGHT -->
            <div class="col-md-5">
                <h1 class="display-5 fw-800 text-primary mb-3"><strong>Invitation Cards</strong></h1>
                <p class="text-muted lead font-mina mb-4" style="font-weight: 300;">
                    Let's style the way that sets the tone for an event.
                </p>
                ...
                <a href="product_customization.php" class="btn btn-orange w-100 py-3 fs-5" data-product-id="6" onclick="goToCustomize(event)">
